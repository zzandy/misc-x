...
System.register("lib/loop", [], function (exports_2, context_2) {
    "use strict";
...
System.register("lib/geometry", [], function (exports_3, context_3) {
    "use strict";
...
System.register("lib/supercell", ["lib/geometry"], function (exports_4, context_4) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_4("Supercell", Supercell);
        }
    };
});
System.register("lib/cellstore", ["lib/supercell"], function (exports_5, context_5) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_5("CellStore", CellStore);
        }
    };
});
System.register("lib/util", [], function (exports_6, context_6) {
    "use strict";
...
System.register("pellets/src/world", ["lib/cellstore", "lib/supercell", "lib/util", "lib/color"], function (exports_8, context_8) {
    "use strict";
    ...
    var cellstore_1, supercell_2, util_1, color_1, red, blue, green, yellow, orange, silver, violet, types, Cell, World;
    return {
        setters: [
        ...
        execute: function () {
            exports_8("red", red = { color: color_1.wheelHcy(0, 1, .25) });
            exports_8("blue", blue = { color: color_1.wheelHcy(240, 1, .35) });
            exports_8("green", green = { color: color_1.wheelHcy(180, 1, .45) });
            exports_8("yellow", yellow = { color: color_1.wheelHcy(90, 1, .8) });
            exports_8("orange", orange = { color: color_1.wheelHcy(45, 1, .5) });
            exports_8("silver", silver = { color: color_1.wheelHcy(90, .1, .9) });
            exports_8("violet", violet = { color: color_1.wheelHcy(305, 1, .5) });
...
System.register("pellets/src/render", ["lib/color"], function (exports_9, context_9) {
    "use strict";
...
System.register("pellets/src/main", ["lib/canvas", "lib/loop", "pellets/src/render", "pellets/src/world", "lib/geometry"], function (exports_10, context_10) {
    "use strict";
    var __moduleName = context_10 && context_10.id;
    function init() {
        var ctx = canvas_1.fullscreenCanvas(false, true);
        var cursor = {
            position: null,
            updated: false,
            down: null,
    ...
    var canvas_1, loop_1, render_1, world_1, geometry_2, main;
    return {
        setters: [
            function (canvas_1_1) {
                canvas_1 = canvas_1_1;
